...
public class MyController {
  ...
  public Object postProduct(@ModelAttribute DAO product)throws Exception {
  ...
  public Object deleteById(@PathVariable("id") Integer id){
	  ...
	  if(p.isPresent()) {
		  ...
		  return ResponseEntity.status(HttpStatus.ACCEPTED)
				  .body(Map.of("messgae","Product id = " + id + "has been deleted"));
	  }
	  
	  return ResponseEntity.status(HttpStatus.NOT_FOUND)
			  .body(Map.of("messgae","Product id = " + id + "not found"));
  }
